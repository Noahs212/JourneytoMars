...
OFILES = gba.o font.o main.o images/garbage.o images/download.o images/images.o images/world.o images/grassybackground.o images/mars1.o images/mars2.o images/playerimage.o
